...
2. Read `AGENTS.md` -- Check project-specific rules and conventions before reviewing.
...
- Skip stylistic preferences unless they violate project conventions in AGENTS.md.
...
- Build commands that differ from what is in `AGENTS.md`
