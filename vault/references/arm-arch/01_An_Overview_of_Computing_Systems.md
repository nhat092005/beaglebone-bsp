---
title: ARM Architecture Chapter 1 An Overview of Computing Systems
tags:
  - arm-arch
  - reference
date: 2026-04-18
...
6. Using the smallest data size possible, either a byte, a halfword (16 bits), or a word (32 bits), convert the following values into two’s complement representations: a. –18,304 b. –20 c. 114 d. –128

7. Indicate whether each value could be represented by a byte, a halfword, or a word-length two’s complement representation: a. –32,765 b. 254 c. –1,000,000 d. –128

8. Using the information from the ARM v7-M Architectural Reference Manual, write out the 16-bit binary value for the instruction SMULBB r5, r4, r3.

9. Describe all the ways of interpreting the hexadecimal number 0xE1A02081 (hint: it might not be data).

10. If the hexadecimal value 0xFFE3 is a two’s complement, halfword value, what would it be in base ten? What if it were a word-length value (i.e., 32 bits long)?

11. How do you think you could quickly compute values in octal (base eight) given a value in binary?

12. Convert the following decimal numbers into hexadecimal: a. 256 b. 1000 c. 4095 d. 42

13. Write the 32-bit representation of –247 in sign-magnitude, one’s complement, and two’s complement notations. Write the answer using 8 hex digits.

14. Write the binary pattern for the letter “Q” using the ASCII representation.

15. Multiply the following binary values. Notice that binary multiplication works exactly like decimal multiplication, except you are either adding 0 to the final product or a scaled multiplicand. For example:
