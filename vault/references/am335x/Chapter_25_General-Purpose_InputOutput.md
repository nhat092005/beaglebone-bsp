---
title: AM335x Chapter 25 General-Purpose Input/Output
tags:
  - am335x
  - reference
date: 2026-04-18
...
_[Sơ đồ GPIO integration - Figure 25-1 và Figure 25-2 - bỏ qua trong phiên bản text]_
...
| GPIO1\_[31:0] | I/O  | General Purpose Input-Output pins |
| GPIO2\_[31:0] | I/O  | General Purpose Input-Output pins |
| GPIO3\_[31:0] | I/O  | General Purpose Input-Output pins |
| GPIO4\_[31:0] | I/O  | General Purpose Input-Output pins |
| GPIO5\_[31:0] | I/O  | General Purpose Input-Output pins |
...
_[Nội dung về Interrupt và Wakeup Events - có sơ đồ Figure 25-3 đến Figure 25-6 - bỏ qua trong phiên bản text]_
...
_[Sơ đồ Figure 25-7 - bỏ qua trong phiên bản text]_
