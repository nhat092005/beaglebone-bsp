...
Partition 1  FAT32, 64 MB — MLO, u-boot.img, zImage, am335x-boneblack.dtb, uEnv.txt
...
Requires patches applied (see [[uboot-config]]). Server default `192.168.1.1`, board default `192.168.1.100`.
